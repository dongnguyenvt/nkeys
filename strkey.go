...
// decode will decode the hexadecimal and check crc16 and the prefix for validity.
...
// DecodeSeed will decode the hexadecimal string and check crc16 and enforce the prefix is a seed
